        ...
        public int Radius
        {
            get
            {
                return !AddHitbox
                    ...
                    : EvadeManager.SkillShotsExtraRadius + _radius + (int)GameObjects.AllyHeroes.FirstOrDefault(x => x.Distance(ObjectManager.GetLocalPlayer()) < Potato_AIO.Bases.Champion.E.Range).BoundingRadius;
            }
            set { _radius = value; }
        }
